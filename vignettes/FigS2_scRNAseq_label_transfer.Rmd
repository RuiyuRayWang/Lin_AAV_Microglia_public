...
This vignette illustrates the label transfer strategy with which the transcriptom states were evaluated for AAV transduced / untransduced / LPS-primed microglia in the original publication (Lin et al., 2022). The strategy is largely inspired by `Seurat` [Multimodal reference mapping vignette](https://satijalab.org/seurat/articles/multimodal_reference_mapping.html) and [Mapping and annotating query datasets vignette](https://satijalab.org/seurat/articles/integration_mapping.html) from Satija group. 
