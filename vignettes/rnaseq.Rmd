---
title: "Lin et al.: AAV Microglia - bulk RNAseq"
...
Download the processed data matrix from GEO. The metadata table can be found in the `miscs/` directory in this github repo.
```{r}
# GEOquery::getGEO(GEO = "GSE197743",filename = "GSE197743_AAV_MG_RNAseq.tsv.gz", destdir = ".")
# download.file(url = "https://www.ncbi.nlm.nih.gov/geo/download/?acc=GSE197743&format=file&file=GSE197743%5FAAV%5FMG%5FRNAseq%2Etsv%2Egz",
#               destfile = "../data/GSE197743/AAV_MG_RNAseq.tsv.gz",
#               method = "wget")
```
